...
$modules = @('test_sys_settrace','test_sys_setprofile','test_profile','test_cprofile','test_monitoring','test_builtin','test_compile','test_code','test_importlib','test_ctypes','test_sysconfig','test_venv','test_signal','test_threading','test_mimetypes','test_winreg','test_pdb','test_traceback','test_inspect')
foreach ($m in $modules) {
  $log = "bench\r13_$m.log"
